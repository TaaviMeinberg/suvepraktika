    ...
    <div class="content">
        ...
        <div class="chapter">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="number" id="bank_account">
            </div>
            <div class="form-group">
        ...
        <div class="chapter">
            ...
            <div class="form-group">
				...
				<small id="confirmation" class="form-text text-muted" style="text-align: center;">
					Vajutades nupule saadab taotluse ära
				</small>
            </div>
        </div>
        </div>
